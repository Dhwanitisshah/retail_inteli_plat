...
📺 **[Illustrated walkthrough](demo.html)** ([rendered preview](https://raw.githack.com/Dhwanitisshah/retail_inteli_plat/main/demo.html)) —
all 5 pipeline modules paired with real store/checkout/backroom photos,
